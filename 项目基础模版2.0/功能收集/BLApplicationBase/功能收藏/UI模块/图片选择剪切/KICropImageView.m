...
- (void)setFrame:(CGRect)frame {
    ...
    [[self cropmaskView] setFrame:self.bounds];
...
- (KICropImageMaskView *)cropmaskView {
    if (_maskView == nil) {
...
- (void)setCropSize:(CGSize)size {
    ...
    [[self cropmaskView] setCropSize:_cropSize];
...
- (UIImage *)cropImage {
    ...
    image = [image resizeToWidth:self.realCropSize.width height:self.realCropSize.height];
